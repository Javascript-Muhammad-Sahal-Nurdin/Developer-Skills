...
// - Transform each elemet to string with °C
...
let printForecast = function (arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    str += `${arr[i]}°C in ${i + 1} days ... `; // Untuk mengetahui caranya gunakan debugger // Caranya sama dengan big sum yang pernah di bawah namun ini untuk string.
  }
  console.log('... ' + str);
};
